...
const MbcsStaffPayrollInvoice = forwardRef<HTMLDivElement, { data: PayrollInvoiceData }>(
  ({ data }, ref) => (
    <div
      ref={ref}
      style={{
...
MbcsStaffPayrollInvoice.displayName = "MbcsStaffPayrollInvoice";
export default MbcsStaffPayrollInvoice;
