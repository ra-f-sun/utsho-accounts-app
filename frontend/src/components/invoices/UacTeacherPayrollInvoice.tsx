...
const UacTeacherPayrollInvoice = forwardRef<HTMLDivElement, { data: PayrollInvoiceData }>(
  ({ data }, ref) => (
    <div
      ref={ref}
      style={{
...
UacTeacherPayrollInvoice.displayName = "UacTeacherPayrollInvoice";
export default UacTeacherPayrollInvoice;
