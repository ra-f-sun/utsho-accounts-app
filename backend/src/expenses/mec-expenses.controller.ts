...
export class MecExpensesController {
  ...
  create(
    ...
    return this.expensesService.create(
      { ...(dto as CreateExpenseDto), organization: 'mec' },
      user.id,
    );
  }
  ...
  findAll(
    ...
    return this.expensesService.findAll('mec', expenseType, expenseMonth);
  }

  @Get('summary/:month')
  getSummary(@Param('month') month: string) {
    return this.expensesService.getOrganizationSummary('mec', month);
  }
